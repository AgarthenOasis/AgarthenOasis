...
public class ButtonSpeedAdjustment extends GameObject {
     ...
     */
    public ButtonSpeedAdjustment(final ObjectRegistry registry, final Group sceneGroup) {
        ...
        // ボタンの作成
        final float posX = UISizeSetting.SwitchAutoButtonSize.x + UISizeSetting.MinimumObjectInterval;
        final float posY = Gdx.graphics.getHeight() - UISizeSetting.SpeedAdjustmentButtonSize.y - UISizeSetting.ScreenOffset;
        final float sizeX = UISizeSetting.SpeedAdjustmentButtonSize.x;
        final float sizeY = UISizeSetting.SpeedAdjustmentButtonSize.y;
